$(document).ready(function() {
        // Função helper para inicializar Select2 com tema BS5
        ...
        // Inicializa todos os selects iniciais
        initSelect2('#id_cidade', 'Selecione uma cidade');
        initSelect2('#id_casa_prisional', 'Selecione uma casa prisional');
        initSelect2('#id_pavilhao', 'Selecione um pavilhão');
        initSelect2('#id_galeria', 'Selecione uma galeria');
        initSelect2('#id_cela', 'Selecione uma cela');
        initSelect2('#id_alojamento', 'Selecione um alojamento');
